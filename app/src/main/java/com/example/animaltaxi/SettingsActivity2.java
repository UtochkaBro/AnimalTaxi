...
public class SettingsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageChangeBtn = (TextView) findViewById(R.id.change_foto_btn);
    ...
    private void ValidateControllers() {
        if (TextUtils.isEmpty(nameET.getText().toString())) {
            ...
            Toast.makeText(this, "Заполните поле марку автомобилея", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadProfileImage() {
        ...
        if (imageUri != null) {
            final StorageReference fileRef = storageProfileImageRef.child(mAuth.getCurrentUser().getUid() + ".jpd");
